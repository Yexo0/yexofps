      ...
      <div className="space-y-3">
        ...
        <div className="stat-card-premium">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-white font-semibold text-sm">{t("phone")}</h3>
          </div>
          <p className="text-white/50 text-xs mb-3">{t("phoneNumber")}</p>
          <div className="flex gap-2">
            <a href="tel:+33647148342" className="btn-ghost-premium !text-xs !py-1.5 !px-4">
              <Phone className="w-3 h-3" />
              {t("call")}
            </a>
            <button
              onClick={() => copyText("0647148342", "phone")}
              className="btn-ghost-premium !text-xs !py-1.5 !px-4"
            >
              {copied === "phone" ? (
                <><Check className="w-3 h-3" />{t("copied")}</>
